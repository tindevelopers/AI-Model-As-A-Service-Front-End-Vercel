-- Seed file to set up tenant admin user profile and tenant association
-- This assumes the auth user already exists in Supabase Auth

-- Step 1: Update or create user profile with tenant_admin role
...
-- Step 2: Associate with test tenant as admin
